...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/list_goals \
  -H 'Content-Type: application/json' \
  -d '{"goal":"1"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/list_goals`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
